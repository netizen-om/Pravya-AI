...
interface QuestionBreakdownPropsExtended extends QuestionBreakdownProps {
  isDark: boolean;
}
...
export default function QuestionBreakdown({
  questions,
  isDark,
}: QuestionBreakdownPropsExtended) {
  return (
    <motion.div
      className="space-y-6"
                    ...
                    <AccordionContent className="space-y-6 pt-4">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="grid gap-3 sm:grid-cols-2">
                          {Object.entries(question.specificFeedback).map(
                            ([key, metric]) => (
                              <div
                                key={key}
                      ...
                      {/* Highlights */}
                      <Alert className="border-green-400 dark:border-green-900 bg-green-200/70  dark:bg-green-950">
                      ...
                      <Alert className="border-blue-400 dark:border-blue-900 bg-blue-300/50 dark:bg-blue-950">
                      ...
                      {question.modelAnswerExample && (
                        <div className="space-y-2">
                          ...
                          <div className="rounded-lg border border-amber-500 dark:border-amber-900 bg-amber-400/60 dark:bg-amber-950 p-4">
