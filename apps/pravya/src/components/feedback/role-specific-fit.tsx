...
export default function RoleSpecificFit({ roleData }: RoleSpecificFitProps) {
  return (
    <motion.div className="space-y-6" variants={itemVariants} initial="hidden" animate="visible">
      <div className="space-y-4">
        <Card className="border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900">
          <CardHeader>
            <CardTitle className="text-base text-neutral-900 dark:text-white">Technical Competency</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900">
          <CardHeader>
            <CardTitle className="text-base text-neutral-900 dark:text-white">Behavioral Competency</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-sm leading-relaxed text-neutral-700 dark:text-neutral-300">
      ...
      <Alert className="border-green-200 dark:border-green-900 bg-green-50 dark:bg-green-950">
        ...
        <AlertTitle className="text-green-900 dark:text-green-200">Overall Fit Assessment</AlertTitle>
