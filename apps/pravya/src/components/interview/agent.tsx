...
const Agent: React.FC<AgentProps> = ({
  ...
  // Volume levels for speaking animation
  const volumeLevels = [30, 60, 90, 70];

  return (
    <div className="flex flex-col items-center justify-center w-full h-full">
      <div className="relative w-64 h-64 flex items-center justify-center">
        {mode === "thinking" ? (
          // Thinking animation (pulsating ring)
          <motion.div
          ...
          // Listening animation (pulsating circle)
          <motion.div
